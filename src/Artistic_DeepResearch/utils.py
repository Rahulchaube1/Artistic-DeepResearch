...
from Artistic_DeepResearch.configuration import Configuration, SearchAPI
from Artistic_DeepResearch.prompts import summarize_webpage_prompt
from Artistic_DeepResearch.state import ResearchComplete, Summary
...
##########################
# Analyst Utils (Deep Reading)
##########################
from Artistic_DeepResearch.analyst import deep_read_url

@tool(description="Deep read and extract content from a specific URL. Use this when you find a highly relevant link and need to read the full content.")
async def deep_read(url: str, config: RunnableConfig = None) -> str:
    """Read a URL in depth."""
    return await deep_read_url(url, config)
...
async def get_all_tools(config: RunnableConfig):
    ...
    tools = [tool(ResearchComplete), think_tool, deep_read]
