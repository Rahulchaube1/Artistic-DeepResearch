# Artistic Deep Research Repository Overview

## Project Description
Artistic Deep Research is a configurable, fully open-source deep research agent that works across multiple model providers, search tools, and MCP (Model Context Protocol) servers. It enables automated research with parallel processing and comprehensive report generation.
...
### Core Implementation (`src/Artistic_DeepResearch/`)
